...
public final class BookmarkActions {

    private BookmarkActions() {
    }

    // 添加当前页面到书签
    public static class Add extends AnAction {
    ...
    // 删除选中的书签
    public static class Remove extends AnAction {
